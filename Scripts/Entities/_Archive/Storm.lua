...
function Storm:OnInit()
	self.thunder_sounds = {
		Sound.Load3DSound("sounds\\thunder\\tclap1.wav",SOUND_UNSCALABLE,255,7,1000),
		Sound.Load3DSound("sounds\\thunder\\tclap2.wav",SOUND_UNSCALABLE,255,7,1000),
		Sound.Load3DSound("sounds\\thunder\\tclap3.wav",SOUND_UNSCALABLE,255,7,1000),
	}		
	self:Activate(1);
	self:OnReset();
end
