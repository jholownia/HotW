...
// ui events
///////////////////////////////////////////////////////////////////////////////////////////////////////////
// (jh) This is where level loading starts.
void CUIGameEvents::OnLoadLevel( const char* mapname, bool isServer, const char* gamerules )
{
	// (jh) In the editor the level would be already loaded
	if (gEnv->IsEditor()) return;

	// (jh) Here console variables are used to set game reulse and then load the map.
	// (jh) Look at GameFramework.cpp and GameRules.cpp for more details.
	// (jh) Apparently detailed game rules are set in a Lua script which is only loaded here?
