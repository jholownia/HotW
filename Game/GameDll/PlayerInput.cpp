	...
	m_fRestingTime(0)
{
	...
	// (jh) Add hardware mouse listener.
...
// (jh)
void CPlayerInput::OnHardwareMouseEvent( int iX, int iY, EHARDWAREMOUSEEVENT eHardwareMouseEvent, int wheelDelta /*= 0*/ )
{
	int mouseX = iX;
	int mouseY = iY;
	
	// hotw::CDebug(4)("Mouse Event: Mouse X: %i, Mouse Y: %i", mouseX, mouseY);
}
